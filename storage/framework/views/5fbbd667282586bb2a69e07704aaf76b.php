...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="<?php echo e(config('app.url')); ?>" class="button">Visitar nuestra web</a>
        </div>

        <!-- Pie de página -->
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Travel Agency. Todos los derechos reservados.</p>
            <p>Has recibido este correo porque te suscribiste en nuestro sitio web.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\gmega\Desktop\Daw\TrabajoFinal\AgenciaDeViajes\backend\resources\views/emails/welcome.blade.php ENDPATH**/ ?>